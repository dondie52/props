    ...
    <DashboardShell title="Dashboard">
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          ...
          />
          <StatCard title="Occupied Units" value={stats.occupiedText} icon={<Users className="h-5 w-5" />} href="/dashboard/tenants" />
          <StatCard title="Rent Due" value={stats.rentDueText} icon={<CreditCard className="h-5 w-5" />} href="/dashboard/payments" />
          <StatCard
